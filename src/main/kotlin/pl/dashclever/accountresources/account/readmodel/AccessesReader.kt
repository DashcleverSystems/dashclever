...
interface AccessesReader : Repository<Account, UUID> {
    ...
    fun accountAccesses(accountId: UUID): Set<AccessDto> {
    ...
    fun accountWorkshopAccesses(accountId: UUID): Set<WorkshopAccessesDto> {
        val accountAccesses: MutableSet<AccessDto> = this.accountAccesses(accountId).toMutableSet()
